...
--
-- Name: categories; Type: TABLE; Schema: task-tracker; Owner: adminz9bkxe1; Tablespace: 
--
...
ALTER TABLE "task-tracker".categories OWNER TO adminz9bkxe1;
...
ALTER TABLE "task-tracker".categories_id_seq OWNER TO adminz9bkxe1;
...
--
-- Name: categories_pkey; Type: CONSTRAINT; Schema: task-tracker; Owner: adminz9bkxe1; Tablespace: 
--
...
--
-- Name: tasks_category-id_fkey; Type: FK CONSTRAINT; Schema: task-tracker; Owner: adminz9bkxe1
--
...
--
-- Name: tasks_parent-task-id_fkey; Type: FK CONSTRAINT; Schema: task-tracker; Owner: adminz9bkxe1
--
