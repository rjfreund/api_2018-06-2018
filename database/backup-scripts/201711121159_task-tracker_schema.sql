...
--
-- Name: task_reminder_occurrences; Type: TABLE; Schema: task-tracker; Owner: adminz9bkxe1; Tablespace: 
--

CREATE TABLE task_reminder_occurrences (
    id integer NOT NULL,
    task_reminder_id integer NOT NULL,
...
ALTER TABLE "task-tracker".task_reminder_occurrences OWNER TO adminz9bkxe1;

--
-- Name: task-reminder-occurrences_id_seq; Type: SEQUENCE; Schema: task-tracker; Owner: adminz9bkxe1
--

CREATE SEQUENCE "task-reminder-occurrences_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE "task-tracker"."task-reminder-occurrences_id_seq" OWNER TO adminz9bkxe1;

--
-- Name: task-reminder-occurrences_id_seq; Type: SEQUENCE OWNED BY; Schema: task-tracker; Owner: adminz9bkxe1
--

ALTER SEQUENCE "task-reminder-occurrences_id_seq" OWNED BY task_reminder_occurrences.id;


--
-- Name: task_history; Type: TABLE; Schema: task-tracker; Owner: adminz9bkxe1; Tablespace: 
--
...
ALTER TABLE "task-tracker".task_history OWNER TO adminz9bkxe1;

--
-- Name: task_history_id_seq; Type: SEQUENCE; Schema: task-tracker; Owner: adminz9bkxe1
--
...
ALTER TABLE "task-tracker".task_history_id_seq OWNER TO adminz9bkxe1;

--
-- Name: task_history_id_seq; Type: SEQUENCE OWNED BY; Schema: task-tracker; Owner: adminz9bkxe1
--
...
--
-- Name: task_status_options; Type: TABLE; Schema: task-tracker; Owner: adminz9bkxe1; Tablespace: 
--
...
ALTER TABLE "task-tracker".task_status_options OWNER TO adminz9bkxe1;

--
-- Name: task_status_options_id_seq; Type: SEQUENCE; Schema: task-tracker; Owner: adminz9bkxe1
--

CREATE SEQUENCE task_status_options_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE "task-tracker".task_status_options_id_seq OWNER TO adminz9bkxe1;

--
-- Name: task_status_options_id_seq; Type: SEQUENCE OWNED BY; Schema: task-tracker; Owner: adminz9bkxe1
--

ALTER SEQUENCE task_status_options_id_seq OWNED BY task_status_options.id;
...
ALTER TABLE ONLY task_reminder_occurrences ALTER COLUMN id SET DEFAULT nextval('"task-reminder-occurrences_id_seq"'::regclass);
...
ALTER TABLE ONLY task_status_options ALTER COLUMN id SET DEFAULT nextval('task_status_options_id_seq'::regclass);
...
--
-- Name: task-reminder-occurrences_pkey; Type: CONSTRAINT; Schema: task-tracker; Owner: adminz9bkxe1; Tablespace: 
--

ALTER TABLE ONLY task_reminder_occurrences
    ADD CONSTRAINT "task-reminder-occurrences_pkey" PRIMARY KEY (id);


--
-- Name: task_history_pkey; Type: CONSTRAINT; Schema: task-tracker; Owner: adminz9bkxe1; Tablespace: 
--
...
--
-- Name: task_status_options_pkey; Type: CONSTRAINT; Schema: task-tracker; Owner: adminz9bkxe1; Tablespace: 
--

ALTER TABLE ONLY task_status_options
    ADD CONSTRAINT task_status_options_pkey PRIMARY KEY (id);
...
--
-- Name: task_reminder_occurrences_created_by_fkey; Type: FK CONSTRAINT; Schema: task-tracker; Owner: adminz9bkxe1
--

ALTER TABLE ONLY task_reminder_occurrences
    ADD CONSTRAINT task_reminder_occurrences_created_by_fkey FOREIGN KEY (created_by) REFERENCES users(id);


--
-- Name: task_reminder_occurrences_modified_by_fkey; Type: FK CONSTRAINT; Schema: task-tracker; Owner: adminz9bkxe1
--

ALTER TABLE ONLY task_reminder_occurrences
    ADD CONSTRAINT task_reminder_occurrences_modified_by_fkey FOREIGN KEY (modified_by) REFERENCES users(id);


--
-- Name: task_reminder_occurrences_task_reminder_id_fkey; Type: FK CONSTRAINT; Schema: task-tracker; Owner: adminz9bkxe1
--

ALTER TABLE ONLY task_reminder_occurrences
    ADD CONSTRAINT task_reminder_occurrences_task_reminder_id_fkey FOREIGN KEY (task_reminder_id) REFERENCES task_reminders(id);


--
-- Name: task_reminders_created_by_fkey; Type: FK CONSTRAINT; Schema: task-tracker; Owner: adminz9bkxe1
--

ALTER TABLE ONLY task_reminders
    ADD CONSTRAINT task_reminders_created_by_fkey FOREIGN KEY (created_by) REFERENCES users(id);


--
-- Name: task_reminders_modified_by_fkey; Type: FK CONSTRAINT; Schema: task-tracker; Owner: adminz9bkxe1
--

ALTER TABLE ONLY task_reminders
    ADD CONSTRAINT task_reminders_modified_by_fkey FOREIGN KEY (modified_by) REFERENCES users(id);


--
-- Name: tasks_parent_id_fkey; Type: FK CONSTRAINT; Schema: task-tracker; Owner: adminz9bkxe1
--
...
--
-- Name: tasks_status_id_fkey; Type: FK CONSTRAINT; Schema: task-tracker; Owner: adminz9bkxe1
--

ALTER TABLE ONLY tasks
    ADD CONSTRAINT tasks_status_id_fkey FOREIGN KEY (status_id) REFERENCES task_status_options(id);
